...
const Work = () => {
  ...
  return (
    <section id="work" className="h-screen snap-start bg-black relative overflow-hidden">
      <div 
        ref={containerRef}
      ...
      >
        {/* Intro Page */}
        <div className="h-full w-full snap-start flex flex-col items-center justify-center p-6 md:p-20 relative">
        ...
        {projects.map((project, index) => (
          <div key={project.id} className="h-full w-full snap-start flex flex-col items-center justify-center p-6 md:p-20 relative">
